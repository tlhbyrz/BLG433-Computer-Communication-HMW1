...
class Client:
    ...
    def __init__(self, **kwargs):
        ...
        self.gui.title("Hangman Game")  # Setting window title
        ...
        self.messages = tkinter.Listbox(self.messages_frame, height=30, width=200, yscrollcommand=self.scrollbar.set)
